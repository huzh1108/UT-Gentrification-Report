...
```{r}
Austin_tracts_2000 <- map_dfr(c("TX"), ~{
  tracts(.x, cb = TRUE, year = 2000)
})

Austin_metro_2000 <- core_based_statistical_areas(cb = TRUE, year = 2010) %>%
  filter(str_detect(NAME, "Austin-Round"))


au_tracts_within_2000 <- Austin_tracts_2000 %>%
  st_filter(Austin_metro_2000, .predicate = st_within)

#au_tracts_2000 <- c(au_tracts_within_2000$GEOID)
```
